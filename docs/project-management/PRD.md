...
## 7. 下一步开发清单 (Next Steps)

### 优先级 P0（核心功能）

1. **数据灌入**：运行 AI 脚本，把数据库填满真数据
2. **收藏功能**：创建 users 和 favorites 表，实现收藏逻辑
3. **搜索功能**：实现关键词搜索（公司名、职位）

### 优先级 P1（体验优化）

4. **个人中心**：实现 OpenID 登录、我的收藏、浏览足迹
5. **行动点功能**：复制链接、保存二维码、添加日历
6. **UI 优化**：Skeleton 加载、空状态、过期标识

### 优先级 P2（运营支持）

7. **真机调试**：在手机上测试所有功能是否正常
8. **UI 微调**：根据真数据调整文字间距、颜色
9. **提审发布**：准备好小程序介绍文案和截图，提交微信审核
